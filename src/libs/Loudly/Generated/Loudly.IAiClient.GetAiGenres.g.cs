...
namespace Loudly
{
    public partial interface IAiClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loudly.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Loudly.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Loudly.AiGenre>>> GetAiGenresAsResponseAsync(
            global::Loudly.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
}