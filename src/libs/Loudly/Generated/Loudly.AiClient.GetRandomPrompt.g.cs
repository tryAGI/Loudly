...
namespace Loudly
{
    public partial class AiClient
    {
        ...
        private static readonly global::Loudly.EndPointSecurityRequirement s_GetRandomPromptSecurityRequirement0 =
        ...
        private static readonly global::Loudly.EndPointSecurityRequirement[] s_GetRandomPromptSecurityRequirements =
            new global::Loudly.EndPointSecurityRequirement[]
            {                s_GetRandomPromptSecurityRequirement0,
            };
        partial void PrepareGetRandomPromptArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetRandomPromptRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetRandomPromptResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetRandomPromptResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Loudly.RandomPrompt> GetRandomPromptAsync(
            global::Loudly.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetRandomPromptAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loudly.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loudly.AutoSDKHttpResponse<global::Loudly.RandomPrompt>> GetRandomPromptAsResponseAsync(
            global::Loudly.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetRandomPromptArguments(
                httpClient: HttpClient);


            var __authorizations = global::Loudly.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetRandomPromptSecurityRequirements,
                operationName: "GetRandomPromptAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loudly.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loudly.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetRandomPromptAsync",
                                pathTemplate: "\"/b2b/ai/prompt/random\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetRandomPromptResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loudly.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetRandomPromptResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Loudly.RandomPrompt.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Loudly.AutoSDKHttpResponse<global::Loudly.RandomPrompt>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Loudly.RandomPrompt.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
