...
namespace Loudly
{
    public partial interface ICatalogClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loudly.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Loudly.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Loudly.CatalogSong>>> GetCatalogSongsAsResponseAsync(
            string? mood = default,
            string? genre = default,
            string? key = default,
            int? page = default,
