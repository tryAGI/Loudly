...
namespace Loudly
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Loudly.AutoSDKRetryOptions Retry { get; set; } = new global::Loudly.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Loudly.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Loudly.IAutoSDKHook>();
        ...
        public global::Loudly.AutoSDKClientOptions AddHook(
            global::Loudly.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Loudly.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Loudly.AutoSDKClientOptions UseAuthorizationProvider(
            global::Loudly.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Loudly.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Loudly.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Loudly.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Loudly.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Loudly.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Loudly.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Loudly.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Loudly.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Loudly.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Loudly.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Loudly.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Loudly.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Loudly.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Loudly.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Loudly.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Loudly.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Loudly.AutoSDKClientOptions clientOptions,
            global::Loudly.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Loudly.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Loudly.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Loudly.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Loudly.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Loudly.IAutoSDKHook, global::Loudly.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Loudly.AutoSDKHookContext context)
        {
